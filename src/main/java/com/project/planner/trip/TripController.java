...
public class TripController {
    ...
    public ResponseEntity<List<ParticipantData>> listAllParticipants(@PathVariable final UUID id) {
    ...
    public ResponseEntity<ActivityResponse> registerActivity(@PathVariable final UUID id, @RequestBody final ActivityRequestPayload payload) {
        ...
        if (trip.isPresent()) {
            final var rawTrip = trip.get();
            final var activityResponse = this.activityService.registerActivity(payload, rawTrip);
    ...
    public ResponseEntity<List<ActivityData>> listAllActivities(@PathVariable final UUID id) {
    ...
    public ResponseEntity<LinkResponse> registerLink(@PathVariable final UUID id, @RequestBody final LinkRequestPayload payload) {
        ...
        if (trip.isPresent()) {
            final var rawTrip = trip.get();
            final var linkResponse = this.linkService.registerLink(payload, rawTrip);
    ...
    @GetMapping("/links/{id}")
    public ResponseEntity<List<LinkData>> listAllLinks(@PathVariable final UUID id) {
